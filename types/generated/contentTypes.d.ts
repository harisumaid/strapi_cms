...
export interface ApiTrgStaticTrgStatic extends Schema.SingleType {
  collectionName: 'trg_statics';
  info: {
  ...
  attributes: {
    facebookSocialHandle: Attribute.String;
    instagramSocialHandle: Attribute.String;
    xSocialHandle: Attribute.String;
